                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="avatar-md profile-user-wid mb-4">
                            <img src="<?= base_url() ?>assets/admin/images/users/avatar-1.jpg" alt="" class="img-thumbnail rounded-circle">
                        </div>
                        <h5 class="font-size-15 text-truncate">Admin </h5>
                        <p class="text-muted mb-0 text-truncate">Franchise</p>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium">Confirmed Orders</p>
            ...
            <div class="col-md-4">
                <div class="card mini-stats-wid">
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="flex-grow-1">
                                <p class="text-muted fw-medium">Printing press</p>
                    ...
                    <table class="table align-middle table-nowrap">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">
                                    <div>
                                        <img src="<?= base_url() ?>assets/admin/images/product/img-7.png" alt="" class="avatar-sm">
                                    </div>
                                </th>
                                <td>
                                    <div>
                            ...
                            <tr>
                                <th scope="row">
                                    <div>
                                        <img src="<?= base_url() ?>assets/admin/images/product/img-4.png" alt="" class="avatar-sm">
                                    </div>
                                </th>
                                <td>
                                    <div>
